...
![Locations in Tallinn](assets/tallinn_locations_rounded_2_decimal_places.png)


## Kampala: almost equator 

![Locations in Kampala](assets/kampala_locations_rounded_2_decimal_places.png)
...
## {data-background="assets/estonia_drivers_locations.png"}
...
## {data-background="https://images-na.ssl-images-amazon.com/images/I/91dIWEyax1L.jpg"}


## The map layer (topojson!)

1. In the database, we defined functions to jump from a point to its square. A square consists of an ID and corners' locations.
